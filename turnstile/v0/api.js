...
(function () {
  ...
  function Pe(e) {
    for (var t = 1; t < arguments.length; t++) {
      var a = arguments[t] != null ? arguments[t] : {}, o = Object.keys(a);
  ...
  var Kt = {
    code: 200500,
    description: "Turnstile's%20api.js%20was%20loaded,%20but%20the%20iframe%20under%20challenges.cloudflare.com%20(or%20challenges.fed.cloudflare.com)%20could%20not%20be%20loaded.%20Has%20the%20visitor%20blocked%20some%20parts%20of%20challenges.cloudflare.com%20or%20are%20they%20self-hosting%20api.js",
  ...
  var je = "cf-chl-widget-", U = "cloudflare-challenge", er = ".cf-turnstile", tr = ".cf-challenge", rr = ".g-recaptcha", lt = "cf_challenge_response", st = "cf-turnstile-response", dt = "g-recaptcha-response", ar = 8000, ft = "private-token", nr = 3, ir = 500, or = 500, Q = "";
  var H;
  (function (e) {
  ...
  var Nr = ["bg-bg", "da-dk", "de-de", "el-gr", "ja-jp", "ms-my", "ru-ru", "sk-sk", "sl-si", "sr-ba", "tl-ph", "uk-ua"], Lr = ["ar-eg", "es-es", "cs-cz", "fa-ir", "fr-fr", "hr-hr", "hu-hu", "id-id", "it-it", "lt-lt", "nb-no", "nl-nl", "pl-pl", "pt-br", "th-th", "tr-tr", "ro-ro"], cr = ["https://challenges.cloudflare.com", "https://challenges-staging.cloudflare.com", "https://challenges.fed.cloudflare.com"];
  function pt(e, t, a) {
  ...
  function vt(e, t, a, o, c, u, g, y, f) {
    var d = pt(a, c, y), w = u ? ("h/").concat(u, "/") : "", R = f ? ("?").concat(f) : "", C = a["feedback-enabled"] === !1 ? "fbD" : "fbE";
    return ("").concat(d, "/cdn-cgi/challenge-platform/").concat(w, "turnstile/f/ov2/av0/rch").concat(o, "/").concat(e, "/").concat(t, "/").concat(a.theme, "/").concat(C, "/").concat(g, "/").concat(a.size, "/").concat(a.language).concat(R);
  }
  var mt = function (e) {
    ...
    var t = e.isVerboseLanguage, a = e.isSmallerFeedback, o = e.isModeratelyVerbose;
  ...
  function Oe(e, t, a) {
    return (He() ? Oe = Reflect.construct : Oe = function (c, u, g) {
      var y = [null];
      y.push.apply(y, u);
      var f = Function.bind.apply(c, y), d = new f();
  ...
  var pr = (function (e) {
    ...
    function a(o, c) {
      ur(this, a);
      var u;
      return (u = t.call(this, o), De(ze(u), "code", void 0), u.name = "TurnstileError", u.code = c, u);
    }
    return a;
  })(Be(Error));
  function v(e, t) {
  ...
  function gt() {
    var e = /^(?:https?:)?\/\/challenges(?:\.fed)?\.cloudflare\.com\/turnstile\/v0(\/.*)?\/api\.js/, t = document.currentScript;
    if (V(t, HTMLScriptElement) && e.test(t.src)) return t;
    for (var a = document.querySelectorAll("script"), o = 0, c; c = a[o]; o++) if (V(c, HTMLScriptElement) && e.test(c.src)) return c;
  }
  function vr() {
    var e = gt();
  ...
  var ht = function (e, t, a, o) {
    var c = pt(t.params, !1, o), u = ("h/").concat("b", "/"), g, y, f = ("").concat(c, "/cdn-cgi/challenge-platform/").concat(u, "feedback-reports/").concat(Ge(e), "/").concat(t.displayLanguage, "/").concat((y = t.params.theme) !== null && y !== void 0 ? y : t.theme, "/").concat(a);
  ...
  function gr(e) {
    ...
    var t = function (a, o) {
      ...
      var g = yt(a.tagName.toLowerCase()), y = ("").concat(g, "[").concat(c, "]");
  ...
  function yr(e) {
    ...
    if (!t) return "nf";
    var a = Array.from(t.querySelectorAll("input, select, textarea, button")), o = a.slice(0, 20).map(function (u) {
      return Dr[u.type] || "-";
    }).join(""), c = [("m:").concat(t.method || ""), ("f:").concat(a.length), o].join("|");
    return c;
  }
  function _r(e, t, a) {
  ...
  function xr(e, t) {
    ...
    if (!(!o || !o.parentNode)) {
      ...
      e._pState = t;
      var u = new URL(o.src), g = document.createElement("script");
    ...
    try {
      for (var c = e.widgetMap[Symbol.iterator](), u; !(t = (u = c.next()).done); t = !0) {
        ...
        if (!(f.isComplete || f.isFailed || f.isResetting)) {
          var C = f.watchcat.seq - 1 - qr, T = f.watchcat.lastAckedSeq < C, k = f.watchcat.seq - 1 - zr, M = f.isOverrunning && f.watchcat.overrunBeginSeq < k;
  ...
  function Lt(e, t) {
    var a = t.params, o = a.size, c = o === void 0 ? "normal" : o, u = t.mode;
    switch (u) {
      ...
      case H.Invisible:
        ...
        break;
      default:
        v(("Invalid value for parameter \"mode\", expected \"").concat(H.NonInteractive, "\", \"").concat(H.Managed, "\" or \"").concat(H.Invisible, "\", got \"").concat(u, "\""), 2818);
    }
  }
  function Sr(e) {
  ...
  var Vt = (function () {
    var e = function (n, i, r, l) {
      ...
      if (n.params.retry === ge.Auto || r) {
        ...
        var l, s = r ? 0 : 1000 * 2 + ((l = n.params["retry-interval"]) !== null && l !== void 0 ? l : 0);
        n.retryTimeout = window.setTimeout(function () {
          var h = r ? B.CrashedRetry : B.FailureRetry;
          w(h, i);
        }, s);
      }
    }, a = function (n, i, r) {
      var l;
      (n.response === void 0 && v("[Internal Error] Widget was completed but no response was given", 1362), n.isExecuting = !1, n.isComplete = !0, Ir(i, n.response), (l = n.cbSuccess) === null || l === void 0 || l.call(n, n.response, r));
    }, o = function (n) {
      if (!n) return [];
      ...
      var n = "abcdefghijklmnopqrstuvwxyz0123456789", i = n.length, r = "";
      do {
        r = "";
      ...
      if (i) {
        var r = ["retry-interval", "retry", "size", "theme", "tabindex", "execution", "refresh-expired", "refresh-timeout", "response-field-name", "response-field", "language", "base-url", "appearance", "sitekey", "feedback-enabled"], l = [], s = !0, h = !1, x = void 0;
        try {
          for (var E = r[Symbol.iterator](), I; !(s = (I = E.next()).done); s = !0) {
            var O = I.value;
            i[O] && i[O] !== n.params[O] && l.push(O);
          }
        } catch (P) {
          (h = !0, x = P);
        } finally {
      ...
      if (l) {
        var s;
        (l.isResetting = !0, l.response = void 0, l.mode = void 0, l.msgQueue = [], l.isComplete = !1, l.isExecuting = !1, l.isExpired = !1, l.isFailed = !1, l.isInitialized = !1, l.isStale = !1, l.watchcat.lastAckedSeq = 0, l.watchcat.seq = 0, l.params.execution === he.Render && (l.msgQueue.push(ce.Execute), l.isExecuted = !0, l.isExecuting = !0));
        var h = J(r), x = l.shadow.querySelector(("#").concat(h));
      ...
      var l = J(r), s = [("input#").concat(l, "_response"), ("input#").concat(l, "_legacy_response"), ("input#").concat(l, "_g_response")];
      ...
      var le = Yr(h);
      if (le) {
        var p = Object.assign(le, i), te = p.action, se = p.cData, be = p.chlPageData, q = p.sitekey, de;
        ...
        var fe;
        p["expiry-interval"] = Number((fe = p["expiry-interval"]) !== null && fe !== void 0 ? fe : ($t - Jt) * 1000);
        var ne;
        p.size = (ne = p.size) !== null && ne !== void 0 ? ne : L.Normal;
        var Ee = p.callback, ke = p["expired-callback"], Te = p["timeout-callback"], Re = p["after-interactive-callback"], Se = p["before-interactive-callback"], ie = p["error-callback"], Ke = p["unsupported-callback"];
        ...
        var z = document.createElement("iframe"), pe = document.createElement("div"), Ut = pe.attachShadow({
          mode: "closed"
        });
        ...
        var Ie = u(), ve = J(Ie);
        if (!(!Ie || !ve)) {
          var jt = [], et = p.execution === he.Render;
          ...
          (F((rt = (l = document.featurePolicy) === null || l === void 0 || (r = l.features) === null || r === void 0 ? void 0 : r.call(l)) !== null && rt !== void 0 ? rt : [], ft) && qt.push(ft), z.setAttribute("allow", qt.join("; ")), z.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"), z.id = ve);
          var at;
    ...
    function k() {
      return (k = Bt(function (_, n, i, r) {
        var l, s, h, x, E, I, O, P, G, ee;
    ...
    var M = function (_) {
      ...
      if (n.source === U) {
        ...
        if (!(!n.widgetId || !m.widgetMap.has(n.widgetId))) {
          var i = J(n.widgetId), r = m.widgetMap.get(n.widgetId);
          if (!(!i || !r)) switch (n.event) {
            ...
            case "fail":
              {
                ...
                var P = r.cbError, G = n.code === We || n.code === Ue;
                if (G) {
            ...
            case "tokenExpired":
              {
                var ae, we = n.token;
                (r.isExpired = !0, (ae = r.cbExpired) === null || ae === void 0 || ae.call(r, we), r.params["refresh-expired"] === K.Auto && !r.isResetting && w(B.AutoExpire, i));
                break;
              }
            case "interactiveTimeout":
              {
                ...
                if ((fe ? fe() : r.params["refresh-timeout"] === oe.Never && !r.isResetting && b("The widget encountered an interactive timeout and is set to never refresh. Consider defining a timeout handler and resetting the widget upon timeout as solving a widget in a timed-out state is going to fail."), r.params["refresh-timeout"] === oe.Auto && !r.isResetting)) {
                  ...
                  (ne == null || ne(), w(B.AutoTimeout, i));
                }
                break;
              }
            case "refreshRequest":
              {
                (c(r, Q, n.widgetId), w(B.ManualRefresh, i));
                break;
              }
            case "reloadRequest":
              {
    ...
    return ot(Pe({}, N), {
        ...
        showFeedback: function (n) {
          ...
          if (i) {
            ...
            if (r) {
              ...
              l && ht(r, l, Xe.Custom, m.scriptUrlParsed);
            }
          }
        }
      },
      execute: function (n, i) {
        ...
        if (s) {
          ...
          (s.isExpired && b(("Call to execute on a expired-widget (").concat(h, "), consider using reset() before.")), s.isStale && (w(B.StaleExecute, h), s.isExecuting = !0), s.msgQueue.push(ce.Execute), s.isExecuted = !0);
  ...
  function Yr(e) {
    var t = e.getAttribute("data-sitekey"), a = {
      sitekey: t
    ...
    if ((u && (Rt(u) ? a.size = u : b(("Unknown data-size value: \"").concat(u, "\"."))), 0)) var g;
