...
(() => {
  ...
  var It = Object.getPrototypeOf, Rt = Object.prototype.hasOwnProperty;
  var wt = (s, o) => () => (o || s((o = {
    exports: {}
  }).exports, o), o.exports);
  var Ct = (s, o, n, r) => {
    if (o && typeof o == "object" || typeof o == "function") for (let e of ht(o)) !Rt.call(s, e) && e !== n && q(s, e, {
      get: () => o[e],
      ...
      return (function () {
        var s = {
          686: function (r, e, t) {
            ...
            var c = t(279), a = t.n(c), d = t(370), y = t.n(d), T = t(817), x = t.n(T);
            function b(p) {
              try {
            ...
            function v(p) {
              var u = document.documentElement.getAttribute("dir") === "rtl", i = document.createElement("textarea");
            ...
            var pt = function () {
              var u = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, i = u.action, l = i === void 0 ? "copy" : i, f = u.container, m = u.target, S = u.text;
              if (l !== "copy" && l !== "cut") throw new Error("Invalid \"action\" value, use either \"copy\" or \"cut\"");
              if (m !== void 0) if (m && C(m) === "object" && m.nodeType === 1) {
            ...
            var St = (function (p) {
              ...
              return (yt(i, [{
                ...
                key: "onClick",
                value: function (f) {
                  var m = f.delegateTarget || f.currentTarget, S = this.action(m) || "copy", L = dt({
                    action: S,
                ...
                key: "isSupported",
                value: function () {
                  var f = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : ["copy", "cut"], m = typeof f == "string" ? [f] : f, S = !!document.queryCommandSupported;
          ...
          817: function (r) {
            function e(t) {
              var c;
              if (t.nodeName === "SELECT") (t.focus(), c = t.value); else if (t.nodeName === "INPUT" || t.nodeName === "TEXTAREA") {
          ...
          279: function (r) {
            ...
            (e.prototype = {
              ...
              emit: function (t) {
                var c = [].slice.call(arguments, 1), a = ((this.e || (this.e = {}))[t] || []).slice(), d = 0, y = a.length;
                for (d; d < y; d++) a[d].fn.apply(a[d].ctx, c);
                return this;
              },
              off: function (t, c) {
                var a = this.e || (this.e = {}), d = a[t], y = [];
  ...
  var k = () => {};
  var K = s => {
    let o = s.split("-"), n = parseInt(o[o.length - 1]);
    if (!isNaN(n)) return n;
  };
  var N = s => {
    var n;
    let o;
    for (let r of s.childNodes) if ((r instanceof HTMLElement && r.childNodes.length ? o = N(r) : r.nodeType === Node.TEXT_NODE && ((n = r.textContent) == null ? void 0 : n.trim()) && (o = r), o)) break;
    return o;
  };
  ...
  var Lt = `${g}-support`, Nt = "npm/@finsweet/attributes-support@1/support.js", Q = async () => {
    let {fsAttributes: s, location: o} = window, {host: n, searchParams: r} = new URL(o.href);
    s.support || (s.support = {});
    let {support: e} = s;
  ...
  var W = s => o => `${s}${o ? `-${o}` : ""}`, O = s => {
    ...
    function n(r, e) {
      let t = o("element", r, e), c = (e == null ? void 0 : e.scope) || document;
  ...
  var Z = s => {
    let {currentScript: o} = document, n = {};
    if (!o) return {
      attributes: n,
      preventsLoad: !1
    };
  ...
  var et = ({scriptAttributes: s, attributeKey: o, version: n, init: r}) => {
    ...
    let {preventsLoad: e, attributes: t} = Z(s), c = window.fsAttributes[o];
  ...
  var h = `fs-${_}`, kt = "click", Kt = "copy-this", Vt = "copy-sibling", Dt = "text", Ft = "message", $t = "duration", jt = "active", $ = {
    element: {
      key: `${h}-element`,
      values: {
        trigger: kt,
  ...
  }, [ot, j] = O($), st = 1000, it = `${h}_active`;
  var ut = Ut(ct(), 1), at = ({trigger: s, textToCopy: o, target: n, textNode: r, originalText: e, successMessage: t, successDuration: c, successClass: a}) => {
  ...
  var {element: {key: Ht}, text: {key: Gt}, successMessage: {key: Yt}, successDuration: {key: qt}, successClass: {key: Xt}} = $, lt = async () => {
    await J(X);
    let o = j("trigger", {
      operator: "prefixed",
      all: !0
      ...
      let r = n.getAttribute(Gt), e = n.getAttribute(Yt), t = +(n.getAttribute(qt) || st), c = n.getAttribute(Xt) || it, a = nt(n, Ht), y = ((A = n.parentElement) == null ? void 0 : A.querySelector(ot("element", "sibling", {
        operator: "prefixed"
      }))) || j("target", {
        instanceIndex: a
      }), T = N(n), x = T ? T.textContent : void 0;
      return at({
        trigger: n,
        target: y,
        textToCopy: r,
