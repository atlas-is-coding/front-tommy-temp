          ...
          if (b) {
            ...
            try {
              b = "0" === c(0) && "0" === c(new t()) && "\"\"" == c(new A()) && c(u) === w && c(w) === w && c() === w && "1" === c(e) && "[1]" == c([e]) && "[null]" == c([w]) && "null" == c(null) && "[null,null,null]" == c([w, u, null]) && "{\"a\":[1,true,false,null,\"\\u0000\\b\\n\\f\\r\\t\"]}" == c({
                a: [e, !0, !1, null, "\u0000\b\n\f\r\t"]
              }) && "1" === c(null, e) && "[\n 1,\n 2\n]" == c([1, 2], null, 1) && "\"-271821-04-20T00:00:00.000Z\"" == c(new C(-8640000000000000)) && "\"+275760-09-13T00:00:00.000Z\"" == c(new C(8640000000000000)) && "\"-000001-01-01T00:00:00.000Z\"" == c(new C(-62198755200000)) && "\"1969-12-31T23:59:59.999Z\"" == c(new C(-1));
            } catch (f) {
              b = !1;
            }
          }
    ...
    if (!q("json")) {
      ...
      if (!q("json-stringify")) {
        var U = {
          ...
          if ("object" == typeof g && g) if ((m = u.call(g), "[object Date]" != m || v.call(g, "toJSON"))) "function" == typeof g.toJSON && ("[object Number]" != m && "[object String]" != m && "[object Array]" != m || v.call(g, "toJSON")) && (g = g.toJSON(a)); else if (g > -1 / 0 && g < 1 / 0) {
            if (E) {
              l = x(g / 86400000);
