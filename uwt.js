  ...
  var t = {
      ...
      t.exports = (r = r || (function (t, e) {
        ...
        var i = function () {
          ...
          concat: function (t) {
            ...
            } else for (var c = 0; c < i; c += 4) e[r + c >>> 2] = n[c >>> 2];
          ...
          _process: function (e) {
            var n, r = this._data, i = r.words, o = r.sigBytes, a = this.blockSize, c = o / (4 * a), u = (c = e ? t.ceil(c) : t.max((0 | c) - this._minBufferSize, 0)) * a, l = t.min(4 * u, o);
            if (u) {
    ...
    7219: function (t, e, n) {
      ...
      t.exports = (r = n(6173), (function (t) {
        var e = r, n = e.lib, i = n.WordArray, o = n.Hasher, a = e.algo, c = [], u = [];
        !(function () {
          function e(e) {
          ...
          for (var r = 2, i = 0; i < 64; ) (e(r) && (i < 8 && (c[i] = n(t.pow(r, 0.5))), u[i] = n(t.pow(r, 1 / 3)), i++), r++);
        })();
        var s = [], l = a.SHA256 = o.extend({
          _doReset: function () {
          ...
          _doProcessBlock: function (t, e) {
            for (var n = this._hash.words, r = n[0], i = n[1], o = n[2], a = n[3], c = n[4], l = n[5], f = n[6], d = n[7], h = 0; h < 64; h++) {
              if (h < 16) s[h] = 0 | t[e + h]; else {
                var p = s[h - 15], v = (p << 25 | p >>> 7) ^ (p << 14 | p >>> 18) ^ p >>> 3, y = s[h - 2], m = (y << 15 | y >>> 17) ^ (y << 13 | y >>> 19) ^ y >>> 10;
                s[h] = v + s[h - 7] + m + s[h - 16];
              }
              var _ = r & i ^ r & o ^ i & o, g = (r << 30 | r >>> 2) ^ (r << 19 | r >>> 13) ^ (r << 10 | r >>> 22), w = d + ((c << 26 | c >>> 6) ^ (c << 21 | c >>> 11) ^ (c << 7 | c >>> 25)) + (c & l ^ ~c & f) + u[h] + s[h];
    ...
    7658: function (t) {
      var e = (function (t) {
        ...
        return (d.prototype = h, c(m, "constructor", h), c(h, "constructor", d), d.displayName = c(h, a, "GeneratorFunction"), t.isGeneratorFunction = function (t) {
          ...
          constructor: E,
          reset: function (t) {
            if ((this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = !1, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(P), !t)) for (var e in this) "t" === e.charAt(0) && n.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = void 0);
          },
          stop: function () {
            this.done = !0;
    ...
    5494: function (t, e, n) {
      ...
      var l, f, d = function (t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n = (u[t[e + 0]] + u[t[e + 1]] + u[t[e + 2]] + u[t[e + 3]] + "-" + u[t[e + 4]] + u[t[e + 5]] + "-" + u[t[e + 6]] + u[t[e + 7]] + "-" + u[t[e + 8]] + u[t[e + 9]] + "-" + u[t[e + 10]] + u[t[e + 11]] + u[t[e + 12]] + u[t[e + 13]] + u[t[e + 14]] + u[t[e + 15]]).toLowerCase();
        if (!c(n)) throw TypeError("Stringified UUID is invalid");
        return n;
      }, h = 0, p = 0;
      var v = function (t, e, n) {
        var r = e && n || 0, i = e || new Array(16), a = (t = t || ({})).node || l, c = void 0 !== t.clockseq ? t.clockseq : f;
        if (null == a || null == c) {
          var u = t.random || (t.rng || o)();
          (null == a && (a = l = [1 | u[0], u[1], u[2], u[3], u[4], u[5]]), null == c && (c = f = 16383 & (u[6] << 8 | u[7])));
        }
        var s = void 0 !== t.msecs ? t.msecs : Date.now(), v = void 0 !== t.nsecs ? t.nsecs : p + 1, y = s - h + (v - p) / 10000;
        if ((y < 0 && void 0 === t.clockseq && (c = c + 1 & 16383), (y < 0 || s > h) && void 0 === t.nsecs && (v = 0), v >= 10000)) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
        (h = s, p = v, f = c);
        var m = (10000 * (268435455 & (s += 12219292800000)) + v) % 4294967296;
        (i[r++] = m >>> 24 & 255, i[r++] = m >>> 16 & 255, i[r++] = m >>> 8 & 255, i[r++] = 255 & m);
        var _ = s / 4294967296 * 10000 & 268435455;
      ...
      var C = m("v3", 48, function (t) {
        ...
        return (function (t) {
          for (var e = [], n = 32 * t.length, r = 0; r < n; r += 8) {
            var i = t[r >> 5] >>> r % 32 & 255, o = parseInt(("0123456789abcdef").charAt(i >>> 4 & 15) + ("0123456789abcdef").charAt(15 & i), 16);
            e.push(o);
          }
          return e;
        })((function (t, e) {
      ...
      var I = m("v5", 80, function (t) {
        ...
        for (var f = 0; f < a; ++f) {
          ...
          for (var v = n[0], y = n[1], m = n[2], _ = n[3], g = n[4], w = 0; w < 80; ++w) {
            var b = Math.floor(w / 20), P = x(v, 5) + T(b, y, m, _) + g + e[b] + d[w] >>> 0;
    ...
    6057: function (t, e, n) {
      ...
      var c = a(n(1952)), u = a(n(8352)), s = a(n(3257)), l = n(4654);
    ...
    510: function (t, e, n) {
      ...
      var c = a(n(1952)), u = a(n(3257)), s = n(4654), l = a(n(1454)), f = {};
      e.set = function (t) {
      ...
      e.config = function (t, e) {
        ...
        var i = s.utilities.splitObjectByPropNames(e, c.NonEventParameterKeys), o = i[0], a = i[1], d = new c.EventParams(r(r({}, o), {
          txn_id: t,
      ...
      e.event = function (t, e) {
        ...
        e = e && s.utilities.isObject(e) ? e : {};
        var n, i = s.utilities.parseEventCodeId(t), o = i[0];
        i[1];
        o && (n = f[o] || new c.AccountParams({
          txn_id: o
        }), u.init(n));
        var a = s.utilities.splitObjectByPropNames(e, c.NonEventParameterKeys), l = a[0], d = a[1], h = new c.EventParams(r(r({}, l), {
          txn_id: t,
    ...
    3324: function (t, e, n) {
      ...
      var c = a(n(1952)), u = a(n(3257)), s = n(4654);
    ...
    1454: function (t, e, n) {
      ...
      var c, u = a(n(1952)), s = a(n(3257)), l = n(4654);
      ...
      e.track = function (t, e) {
        ...
        var n = l.utilities.splitObjectByPropNames(e, u.NonEventParameterKeys), i = n[0], o = n[1], a = new u.EventParams(r(r(r({}, i), l.utilities.getLegacyParams(e)), {
          txn_id: c.getPixelId(),
    ...
    1952: function (t, e, n) {
      ...
      var a = n(4654), c = ["email_address", "phone_number", "external_id"], u = ["page_location", "hide_page_location"], s = u.concat(c).concat(["bci", "eci", "event_id", "event", "events", "oct_p_id", "p_id", "p_user_id", "pl_id", "restricted_data_use", "tw_acc_response", "tw_clid_src", "twclid", "tw_document_href", "tw_document_referrer", "tw_iframe_status", "tw_order_quantity", "tw_sale_amount", "tw_product_id", "txn_id", "type", "version", "pt"]);
      ...
      var l = (function () {
        ...
        return (t.prototype.set = function (t) {
          var e = a.utilities.splitObjectByPropNames(t || ({}), c), n = e[0], r = e[1], i = Object.keys(n).reduce(function (t, e) {
      ...
      function y(t, e) {
        ...
        n && (e.pt = n);
        var r = t.hide_page_location ? "" : t.page_location;
        void 0 !== r && (e.tw_document_href = r, e.tw_document_referrer && (e.tw_document_referrer = r));
      }
      (e.globalParams = p, e.setIframe = v, e.setLocation = y, e.merge = function (t) {
        var e = t.accountParams, n = t.eventParams, r = a.utilities.mergeObjects({}, p.get(), (null == e ? void 0 : e.get()) || ({}), n.get()), i = a.utilities.splitObjectByPropNames(r, u), o = i[0], c = i[1];
        return (v(c), y(o, c), c);
      });
    },
    8352: function (t, e, n) {
      ...
      var a = n(4654), c = function (t) {
        return (void 0 === t && (t = a.utilities.AdsApiVersion.v0), "https://t.co/" + t + "/adsct");
      };
      e.TCO_BASE = c;
      var u = (/^(\S+\.)?x\.com/).test(document.location.host) ? "analytics.x.com" : "analytics.twitter.com", s = function (t) {
    ...
    3257: function (t, e, n) {
      ...
      var u = o(n(1952)), s = o(n(8352)), l = n(4654), f = o(n(1304));
      (e.init = function (t) {}, e.track = function (t) {
        var e = t.accountParams, n = t.eventParams, r = t.adsApiVersion;
    ...
    7344: function (t, e) {
      ...
      e.default = function (t) {
        ...
        (e.withCredentials = !0, e.timeout = 2000);
    ...
    1304: function (t, e) {
      ...
      (Object.defineProperty(e, "__esModule", {
        ...
        var t = window.screen || ({}), e = window.navigator || ({}), r = n(), a = (t.width || 0) + "&" + (t.height || 0), c = t.colorDepth || 0, u = t.availWidth || 0, s = t.availHeight || 0, l = Array.isArray(e.languages) ? e.languages.join(",") : e.language || "na", f = e.doNotTrack || "na", d = e.maxTouchPoints || 0, h = e.hardwareConcurrency || 0, p = o("platform"), v = o("vendor"), y = [i(), l, v, p, r, a, h, c, u, s, d, f].join("&");
        return {
          dv: y.length < 1000 ? y : y.slice(0, 1000) + "&end"
        };
      });
    },
    8974: function (t, e, n) {
      ...
      var o, a = n(6575), c = n(3532);
      (!(function (t) {
        (t[t.Href = 1] = "Href", t[t.Cookie = 2] = "Cookie");
      })(o = e.TWCLIDSource || (e.TWCLIDSource = {})), e.TWCLID_COOKIE_NAME = "_twclid", e.TWCLID_COOKIE_TTL = 2592000, e.TWCLID_QUERY_PARAM = "twclid", e.AccRequestCache = {});
    ...
    3532: function (t, e, n) {
      ...
      var o = i(n(7219)), a = n(5494);
      (!(function (t) {
        (t.v0 = "i", t.v1 = "1/i");
      })(e.AdsApiVersion || (e.AdsApiVersion = {})), (function (t) {
        ...
        n.href = t;
        var i = n.origin, o = n.pathname, a = n.search, c = n.hash, u = a.slice(1).split("&").map(function (t) {
          return t.split("=");
        }).reduce(function (t, e) {
          var n, i = e[0], o = e[1];
          return r(((n = {})[i] = o, n), t);
      ...
      function c(t, e) {
        var n = e.toLowerCase();
        for (var r in t) if (r.toLowerCase() === n && t.hasOwnProperty(r)) return t[r];
      }
      ...
      function u(t, e) {
        var n = e.toLowerCase();
        for (var r in t) if (r.toLowerCase() === n && t.hasOwnProperty(r)) return !0;
        return !1;
      }
      function s(t) {
        var e = typeof t;
